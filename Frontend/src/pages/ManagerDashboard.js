                    ...
                    <div className="teams-management">
                        ...
                        {selectedTeam && (
                            <div className="current-coach">
                                ...
                                {coach ? (
                                    <p>
                                        <strong>Name:</strong> {coach.coach_name} <br />
                                        <strong>Email:</strong> {coach.coach_email}
                                    </p>
                                ) : (
                        ...
                        {selectedTeam && (
                            <div className="add-coach-section">
                                {coach ? (
                                    <p>A coach is already assigned to this team. You cannot add another coach.</p>
                                ) : (
                                    <AddCoach teamId={selectedTeam} />
                                )}
                            </div>
                        )}
